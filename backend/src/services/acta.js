    ...
    <div class="row serv no-split">
      ...
      <div class="col">
        ...
        <div style="display:flex;gap:14px;margin-top:4px">
          <div style="flex:1">
            ${r.firmaCliImg ? `<div class="firmaimg no-split"><img src="${esc(r.firmaCliImg)}" crossorigin="anonymous" style="max-height:52px;max-width:100%;object-fit:contain"/></div>` : (r.firmaCli ? `<div class="firmaimg no-split">${firmaSVG(r.firmaCli)}</div>` : '<div class="firmaimg no-split"></div>')}
            <div class="firma">Firma del Cliente</div>
          </div>
          <div style="flex:1">
            ${r.firmaRecImg ? `<div class="firmaimg no-split"><img src="${esc(r.firmaRecImg)}" crossorigin="anonymous" style="max-height:52px;max-width:100%;object-fit:contain"/></div>` : (r.firmaRec ? `<div class="firmaimg no-split">${firmaSVG(r.firmaRec)}</div>` : '<div class="firmaimg no-split"></div>')}

...
async function init() {
  ...
  if (existe) {
    ...
    try { db.exec('ALTER TABLE usuarios ADD COLUMN es_mech INTEGER DEFAULT 0'); } catch (e) {}
    try { db.exec('ALTER TABLE usuarios ADD COLUMN notificar_automatico INTEGER DEFAULT 0'); } catch (e) {}
